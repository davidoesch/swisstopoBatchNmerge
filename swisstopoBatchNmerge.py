...
def browseFiles():
    ...
    label_file_explorer.configure(text="PROCESSING: "+CSV_path+" ...")
    # No need to create a variable, set some magic string to it and pass it to a function
    # Be explicit about what you do
    process(CSV_Value,None)
    label_file_explorer.configure(text="FINISHED: "+CSV_path+".tif  ")
...
# Function does more than check for free space. It displays messages. Name should reflect that.
