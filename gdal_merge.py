...
# changes 14Mar2021
# to install under windows you need gdal, can be cumbersone, try to dowload your version
# from https://www.lfd.uci.edu/~gohlke/pythonlibs/#gdal and install it eg
# pip install C:\Downloads\GDAL-3.2.2-cp39-cp39-win_amd64.wh
